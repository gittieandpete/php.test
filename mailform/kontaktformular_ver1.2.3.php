...
// die folgenden Funktionen nur benutzen in PHP Übungen lokal.
// Um es in andere Projekte einzubinden auskommentieren.
// require '../includes/definitions.php'; // gebraucht für Studiobuchung
...
Content-Transfer-Encoding: 8bit';
    ...
    if ($GLOBALS['testmodus']==1)
        ...
        Header der Mail: <?php print "$header";?>
        </pre>
        <?php
    }
